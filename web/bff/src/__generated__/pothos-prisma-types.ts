...
/* eslint-disable */
import type { Prisma, ModelUser, AuthIdentity, Session, Publisher, Author, Book, Favorite } from "@prisma/client";
...
export default interface PrismaTypes {
    ModelUser: {
        ...
        Create: {};
        Update: {};
        RelationName: "authIdentities" | "sessions" | "favorites" | "addedBooks";
        ListRelations: "authIdentities" | "sessions" | "favorites" | "addedBooks";
        Relations: {
            authIdentities: {
                Shape: AuthIdentity[];
                Name: "AuthIdentity";
